...
exempt_group_list = c('Raw Food', 'Private Education', 'Private Health', 'Financial Services', 
                    'Land Transport', 'International Travel', 'Amusement', 'Renewable Power'
                    'Senior Citizens')
exempt_label_list = c(
